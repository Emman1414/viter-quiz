...
const ModalAddQuestion = ({ itemEdit }) => {
  ...
  return (
    <>
      <ModalWrapper>
        <div className="modal-side absolute top-0 right-0 bg-primary h-[100dvh] w-[450px] border border-line">
                        ...
                        <FieldArray
                          ...
                          render={({ push, remove }) => (
                            <div className="mt-10 relative">
                              ...
                              <button
                                type="button"
                                className="absolute -top-5 right-1 bg-accent flex gap-2 items-center px-2 py-1 rounded-md "
                                onClick={() =>
